...
int main(void)
{
  ...
  UART_queueHandle = osMessageQueueNew(16, sizeof(UART_Msg_t), NULL);
  ...
  UART_TaskHandle = osThreadNew(StartTask04, NULL, &UART_Task_attributes);
...
void StartTask02(void *argument)
{
  ...
  /* Infinite loop */
	...
	UART_Msg_t msg;
	    ...
	    for(;;)
	    {
	        sprintf(msg.data, "Hello from Task1\r\n");
...
void StartTask03(void *argument)
{
  ...
  /* Infinite loop */
	UART_Msg_t msg;
	    ...
	    for(;;)
	    {
	        sprintf(msg.data, "Hello from Task2\r\n");
...
void StartTask04(void *argument)
{
  ...
  /* Infinite loop */
	...
	UART_Msg_t msg;
	    ...
	    for(;;)
	    {
	        if(osMessageQueueGet(UART_queueHandle, &msg, NULL, osWaitForever) == osOK)
	        {
