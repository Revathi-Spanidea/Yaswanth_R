...
int main(void)
{
  ...
  while (1)
  {
//	  status = HAL_I2C_Mem_Read(&hi2c3, SLAVE_ADDR, WHO_AM_I, I2C_MEMADD_SIZE_8BIT, &output, 1, 100);
//
//	  if(status == HAL_OK){
//	  printf("WHO_am_I value:0x%X status: %d\r\n",output,status);
//	  }
//	  else{
//		  printf("I2C error\r\n");
//	  }
//	  HAL_Delay(1000);
	  ...
	  status = HAL_I2C_Mem_Read(&hi2c3,SLAVE_ADDR,0x28 | 0x80,I2C_MEMADD_SIZE_8BIT,buffer,6,100);
